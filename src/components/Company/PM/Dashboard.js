            ...
            <div>
                ...
                <Row gutter={16}>
                    <Col span={6}>
                        <Card>
                            ...
                            <Row>
                                <span style={{ color: '#092b00', fontWeight: 'bold' }}>
                    ...
                    <Col span={6}>
                        <Card>
                            ...
                            <Row>
                                <span style={{ fontSize: '3rem', fontWeight: 'bold' }}>50</span>
                            </Row>
                            <Row>
                ...
                <Row>
                    <Row>
                        <Col span={24}>
                            <Card>
                                <span style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Hospital Management System</span>
                                <span style={{ fontSize: '1rem', color: '#bfbfbf' }}> ongoing project</span>
                            </Card>
                        </Col>
                    </Row>
                    <Row>
